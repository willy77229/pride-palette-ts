...
import { getAuth, signInWithEmailAndPassword, signInWithPopup, GoogleAuthProvider, createUserWithEmailAndPassword, signOut, onAuthStateChanged, User, NextOrObserver } from 'firebase/auth';
...
export const getCategoriesAndDocuments = async (): Promise<Category[]> => {
    ...
    return querySnapshot.docs.map((docSnapsht) => docSnapsht.data() as Category);
}
